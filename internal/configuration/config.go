...
func Default() Config {
	return Config{HTTPAddr: ":8080", NTPAddr: ":8123", NTSAddr: ":8443", MinStratum: 2, Holdover: time.Hour, CookieKey: "chronos-development-cookie-key-32-bytes", RatePerSecond: 100, Sources: []Source{{Name: "primary", Address: "127.0.0.1:9123"}, {Name: "secondary", Address: "127.0.0.1:9124"}, {Name: "faulty", Address: "127.0.0.1:9125", OffsetMS: 5000}}}
}
